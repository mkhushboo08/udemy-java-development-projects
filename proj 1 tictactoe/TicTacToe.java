...
class Fdemo extends Frame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		b[0].getLabel()==b[1].getLabel() && 
		b[0].getLabel()==b[2].getLabel()){
		...
		b[3].getLabel()==b[4].getLabel() && 
		b[3].getLabel()==b[5].getLabel()){
		...
		b[6].getLabel()==b[7].getLabel() && 
		b[6].getLabel()==b[8].getLabel()){
		...
		//columns
		if(!b[0].getLabel().equals("") &&
		b[0].getLabel()==b[3].getLabel() && 
		b[0].getLabel()==b[6].getLabel()){
		...
		b[1].getLabel()==b[4].getLabel() && 
		b[1].getLabel()==b[7].getLabel()){
		...
		b[2].getLabel()==b[5].getLabel() && 
		b[2].getLabel()==b[8].getLabel()){
		...
		//diagonal
		if(!b[0].getLabel().equals("") &&
		b[0].getLabel()==b[4].getLabel() && 
		b[0].getLabel()==b[8].getLabel()){
		...
		if(!b[2].getLabel().equals("") &&
		b[2].getLabel()==b[4].getLabel() && 
		b[2].getLabel()==b[6].getLabel()){
